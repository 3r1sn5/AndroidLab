package com.example.kotlincontentprovidermain
...
class MyContentProvider : ContentProvider()
{
    ...
    override fun insert(uri: Uri, values: ContentValues?): Uri?
    {
        ...
        return Uri.parse("content://com.example.kotlincontentprovidermain/$rowId")
    }
    ...
    override fun query(uri: Uri, projection: Array<String>?, selection: String?, electionArgs: Array<String>?, sortOrder: String?): Cursor?
    {
